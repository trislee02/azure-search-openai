...
from approaches.promptutils import ChatRAGPrompt, ChatVectorComparePrompt, ChatMultiSearchPrompt
...
class ChatRAGMultiSearchApproach(Approach):
    ...
    def run(self, history: Sequence[dict[str, str]], overrides: dict[str, Any]) -> Any:
        ...
        query_texts = chat_completion.choices[0].message.content.strip().split("\n")
